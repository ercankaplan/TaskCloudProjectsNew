...
namespace WSD.TaskCloud.Contracts.EF
{
    ...
    public partial class TaskResponseAttachment: BaseEntityType,IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupAttachment(Attachment previousValue)
        {
            ...
            if (previousValue != null && previousValue.TaskResponseAttachment.Contains(this))
            {
                previousValue.TaskResponseAttachment.Remove(this);
            }
    
            if (Attachment != null)
            {
                Attachment.TaskResponseAttachment.Add(this);
