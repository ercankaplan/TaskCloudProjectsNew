...
namespace WSD.TaskCloud.Contracts.EF
{
    ...
    public partial class TaskAttachment: BaseEntityType,IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupAttachment(Attachment previousValue)
        {
            ...
            if (previousValue != null && previousValue.TaskAttachment.Contains(this))
            {
                previousValue.TaskAttachment.Remove(this);
            }
    
            if (Attachment != null)
            {
                Attachment.TaskAttachment.Add(this);
